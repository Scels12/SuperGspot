...
import ae86profile from "../assets/ae86profile.png";
...
const features = [
  ...
  },
  {
    ...
    description:
      "Multiple gauge layouts and retro themes.",
    icon: "◌",
  },
  {
  ...
  },
  {
    ...
    description:
      "Timely customer support, regular firmware updates",
    icon: "▣",
  },
];
const specs = [
  ...
  return (
    <div className="min-h-screen bg-[#030712] text-white selection:bg-cyan-400/30">
      ...
      <main>
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="mt-14 grid max-w-lg grid-cols-3 gap-6 border-t border-white/10 pt-8">
                {[
                  ...
                  <div key={top} className="border-l border-white/10 pl-4 first:border-l-0 first:pl-0">
          ...
          <div className="mx-auto max-w-7xl px-6">
            ...
            <div className="mb-16 text-center">
              ...
              <p className="mx-auto mt-4 max-w-xl text-white/60">
                Engineered specifically for the AE86 platform. Every detail considered, every gauge perfected.
              </p>
            </div>
        ...
        {/* Product section with specs and what's included, using the same styling as features for consistency */}  
        
        <section id="product" className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-xs font-mono font-medium uppercase tracking-widest text-cyan-400">Product</p>
            <h2 className="mt-4 text-3xl font-bold tracking-tight md:text-5xl">
          ...
          <div className="mt-16 grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
            {/* <div className="overflow-hidden rounded-[2rem] border border-white/8 bg-white/[0.02] p-3">
              <img
                src="https://images.unsplash.com/photo-1489824904134-891ab64532f1?auto=format&fit=crop&w=1400&q=80"
                alt="Digital dashboard product display"
        ...
        <section id="gallery" className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-xs font-mono font-medium uppercase tracking-widest text-cyan-400">Gallery</p>
            <h2 className="mt-4 text-3xl font-bold tracking-tight md:text-5xl">See it in action</h2>
          </div>

          <div className="mt-16 grid gap-5 md:grid-cols-2">
            <div className="overflow-hidden rounded-[2rem] p-3 md:col-span-2">
            <h2 className="mt-4 text-1xl text-center tracking-tight sm:text-1">Installation images coming soon, in the meantime check out this cyberpunk aesthetic </h2>
              <img
                  src={ae86}
                  alt="ae86"
                  className="relative aspect-[16/10] w-full rounded-[1.5rem] object-cover"
            ...
            {/* <div className="overflow-hidden rounded-[2rem] p-3">
              <img
            ...
            <div className="overflow-hidden rounded-[2rem] p-3">
              <img
                ...
                alt="Dashboard display close-up"
                className="aspect-[16/10] w-full rounded-[1.5rem] object-cover"
              />
            </div> */}
          </div>
        ...
        <section id="pricing" className="mx-auto max-w-5xl px-6 py-24 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-xs font-mono font-medium uppercase tracking-widest text-cyan-400">Pricing</p>
            <h2 className="mt-4 text-3xl font-bold tracking-tight md:text-5xl">One price. Everything included.</h2>
          </div>

          <div className="mt-14 rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.02),rgba(34,211,238,0.04))] p-8 transition-all duration-300 hover:border-cyan-400/40 hover:-translate-y-1 hover:shadow-[0_10px_40px_rgba(34,211,238,0.1)] sm:p-12">            <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
              <div>
                ...
                <p className="mt-4 text-xl text-white/65">Complete digital dash kit for your AE86</p>
              </div>
            </div>
            ...
            {/* <p className="mt-6 text-center text-white/45">
              Ships in 2–3 weeks. 30-day money-back guarantee.
            </p> */}
          </div>
        </section>
        ...
        <section id="faq" className="mx-auto max-w-5xl px-6 py-24 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-xs font-mono font-medium uppercase tracking-widest text-cyan-400">FAQ</p>
            <h2 className="mt-4 text-3xl font-bold tracking-tight md:text-5xl"> Questions? Answered.</h2>
          </div>
          ...
          <div className="mt-14 space-y-4">
            {faq.map((item, index) => (
              <details
                key={item.q}
                className="group rounded-2xl border border-white/10 bg-white/[0.02] p-6 open:border-cyan-400/35"
                open={index === 0}
              >
                ...
                <p className="mt-4 max-w-3xl pr-10 text-lg leading-8 text-white/60">{item.a}</p>
              </details>
            ))}
          </div>
        </section>
        ...
        <section id="contact" className="mx-auto max-w-5xl px-6 pb-24 pt-8 lg:px-8">
          <div className="rounded-[2.5rem] border border-white/8 bg-white/[0.02] p-8 sm:p-12">
            <div className="grid gap-10 lg:grid-cols-[1fr_1.1fr] lg:items-start">
              <div>
                <p className="text-sm font-bold uppercase tracking-[0.28em] text-cyan-400">Contact</p>
                <h2 className="mt-5 text-4xl font-black tracking-tight sm:text-5xl">
                  Ready to launch your AE86 interior into the future?
                </h2>
                <p className="mt-6 text-lg leading-8 text-white/60">
                  Replace this with your real contact email, Shopify link, checkout flow,
                  or inquiry form.
                </p>
              </div>
